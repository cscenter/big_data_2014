...
#        print fat_query
    ...
    def get_url_by_id(self, url_id):
        ...
        url = self.con.execute("select url from url_list where url_list.rowid = '%s'" % url_id).fetchall()[0]
        return url
    ...
    def cos_search(self, text):
        ...
        top_text_words = self.get_top_words(text_words, len(text_words))
